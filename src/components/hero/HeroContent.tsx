    ...
    >
      ...
      >
        <Link to="/quiz">
          ...
          >
            <Button 
              className="group bg-mai-coral hover:bg-mai-brown text-white px-8 py-6 rounded-full transition-all duration-300 transform shadow-lg hover:shadow-xl w-full sm:w-auto relative overflow-hidden"
            >
        ...
        <Link to="/products">
          ...
          >
            <Button 
              variant="outline" 
              className="border-2 border-mai-coral text-mai-coral hover:bg-mai-coral hover:text-white px-8 py-6 rounded-full transition-all duration-300 w-full sm:w-auto backdrop-blur-sm relative overflow-hidden group"
            >
              <span className="relative z-10">Browse Products</span>
              <motion.div
                className="absolute inset-0 bg-mai-coral/10"
